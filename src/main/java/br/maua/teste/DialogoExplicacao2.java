...
public class DialogoExplicacao2 extends javax.swing.JFrame {
    ...
    private String[] textos = {
            ...
            "Afinal, é quase como se o ambiente da natureza que os animais estão inseridos, selecionassem aqueles que irão prosperar!"
    };
    private int index = 0;
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoExplicacao2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            DialogoExplicacao2 dialog = new DialogoExplicacao2();

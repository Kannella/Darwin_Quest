...
public class PrimeiraPergunta extends javax.swing.JFrame {
    ...
    PerguntaERespostas perguntaERespostas = conexaoBD.getPerguntaERespostas(1); // Supondo que você quer a pergunta com ID 1

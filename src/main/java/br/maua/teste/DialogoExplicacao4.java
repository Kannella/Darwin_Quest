...
public class DialogoExplicacao4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textAreas = new JTextArea[]{jTextArea2, jTextArea3}; // Agora o balão de cima é o jTextArea2 e o de baixo é o jTextArea3
        configurarTextArea(jTextArea2);
        configurarTextArea(jTextArea3);

        configurarScrollPane(fala_balao, jTextArea2); // Agora o balão de cima é o jTextArea2
        configurarScrollPane(fala_balao1, jTextArea3); // Agora o balão de baixo é o jTextArea3

        getContentPane().add(fala_balao);
        getContentPane().add(fala_balao1);

        fala_balao.setBounds(90, 120, 420, 80);
        fala_balao1.setBounds(300, 340, 420, 80);
        ...
        jLabel3.setBounds(50, 90, 490, 140);
        ...
        jLabel1.setBounds(260, 310, 490, 140);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoExplicacao4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            DialogoExplicacao4 dialog = new DialogoExplicacao4();
